...
- `admin_only` (optional): indicates if the profile is restricted to JupyterHub admins (default: False)
...
| `c.SbatchForm.unlock_for_admins` | `Bool` | Indicates if locked fields are unlocked for JupyterHub admins | `False` |
